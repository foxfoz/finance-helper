...
# Allow wildcard for Railway subdomains during initial deploy
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'staticfiles_collected'],  # For React index.html
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Serve React build files from root URL
WHITENOISE_ROOT = BASE_DIR / 'staticfiles_collected'
